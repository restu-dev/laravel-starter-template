<link rel="stylesheet" href="{{ asset('assets/login_1/css/bootstrap.min.css') }}">
<link rel="stylesheet" href="{{ asset('assets/login_1/css/all.min.css') }}">
...
<script src="{{ asset('assets/login_1/js/jquery-3.3.1.slim.min.js') }}"></script>
<script src="{{ asset('assets/login_1/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('assets/login_1/js/popper.min.js') }}"></script>
